...
create table customers(id uuid primary key,organization_id uuid,full_name text default 'Asha',deleted_at timestamptz);
...
$$;
-- Every permission the test actor holds; individual gates are asserted by
-- signing in as a profile that does not exist instead.
