...
| ------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------- |
| `1`–`8` Telecaller                          | `/telecaller/dashboard`, leads, follow-ups, tasks, calls, messages, appointments, performance                                        | `TenantDashboard`, `LeadWorkspace`, `WorkWorkspace`, `TaskWorkspace`, `CallWorkspace`, `InboxWorkspace`             |
