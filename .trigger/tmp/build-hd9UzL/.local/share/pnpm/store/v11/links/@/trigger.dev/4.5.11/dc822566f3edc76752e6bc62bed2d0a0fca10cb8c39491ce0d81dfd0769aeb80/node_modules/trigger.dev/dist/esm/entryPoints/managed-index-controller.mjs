...
// ../../../../.local/share/pnpm/store/v11/links/@/trigger.dev/4.5.11/dc822566f3edc76752e6bc62bed2d0a0fca10cb8c39491ce0d81dfd0769aeb80/node_modules/trigger.dev/dist/esm/entryPoints/managed-index-controller.js
init_esm();
import { readFile } from "node:fs/promises";
import { join } from "node:path";

// ../../../../.local/share/pnpm/store/v11/links/@/trigger.dev/4.5.11/dc822566f3edc76752e6bc62bed2d0a0fca10cb8c39491ce0d81dfd0769aeb80/node_modules/trigger.dev/dist/esm/apiClient.js
init_esm();
...
var MarkProjectInitializedResponseBody = external_exports.object({
  id: external_exports.string(),
  initializedAt: external_exports.string().nullable()
});
var CliApiClient = class {
  ...
  async markProjectInitialized(projectRef) {
    if (!this.accessToken) {
      throw new Error("markProjectInitialized: No access token");
    }
    return wrapZodFetch(MarkProjectInitializedResponseBody, `${this.apiURL}/api/v1/projects/${projectRef}/init`, {
      method: "POST",
      headers: {
        Authorization: `Bearer ${this.accessToken}`,
        "Content-Type": "application/json"
  ...
  async getReport(key, options) {
    ...
    const response = await fetch(`${this.apiURL}/api/v1/reports/${encodeURIComponent(key)}?${searchParams.toString()}`, {
      method: "GET",
      headers: this.getHeaders()
    });
    if (!response.ok) {
...
// ../../../../.local/share/pnpm/store/v11/links/@/trigger.dev/4.5.11/dc822566f3edc76752e6bc62bed2d0a0fca10cb8c39491ce0d81dfd0769aeb80/node_modules/trigger.dev/dist/esm/indexing/indexWorkerManifest.js
init_esm();
...
// ../../../../.local/share/pnpm/store/v11/links/@/trigger.dev/4.5.11/dc822566f3edc76752e6bc62bed2d0a0fca10cb8c39491ce0d81dfd0769aeb80/node_modules/trigger.dev/dist/esm/utilities/sourceFiles.js
init_esm();
