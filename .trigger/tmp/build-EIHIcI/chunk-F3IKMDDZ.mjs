...
var init_copyDocumentWithTransform = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/serde/copyDocumentWithTransform.js"() {
    init_esm();
    copyDocumentWithTransform = /* @__PURE__ */ __name((source, _schemaRef, _transform = (_) => _) => source, "copyDocumentWithTransform");
  }
});
...
var require_dist_cjs = __commonJS({
  "node_modules/.pnpm/@smithy+types@4.17.0/node_modules/@smithy/types/dist-cjs/index.js"(exports) {
    init_esm();
    ...
    var getChecksumConfiguration2 = /* @__PURE__ */ __name((runtimeConfig) => {
      ...
      if (runtimeConfig.sha256 !== void 0) {
        checksumAlgorithms.push({
          algorithmId: /* @__PURE__ */ __name(() => AlgorithmId2.SHA256, "algorithmId"),
          checksumConstructor: /* @__PURE__ */ __name(() => runtimeConfig.sha256, "checksumConstructor")
        });
      }
      if (runtimeConfig.md5 != void 0) {
        checksumAlgorithms.push({
          algorithmId: /* @__PURE__ */ __name(() => AlgorithmId2.MD5, "algorithmId"),
    ...
    var getDefaultClientConfiguration2 = /* @__PURE__ */ __name((runtimeConfig) => {
...
var init_deserializerMiddleware = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/serde/middleware-serde/deserializerMiddleware.js"() {
    init_esm();
    init_transport();
    deserializerMiddleware = /* @__PURE__ */ __name((options, deserializer) => (next, context) => async (args) => {
...
var init_numberSelector = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/util-config-provider/numberSelector.js"() {
    init_esm();
    numberSelector = /* @__PURE__ */ __name((obj, key, type) => {
      if (!(key in obj))
        return void 0;
...
var init_getSsoSessionData = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/shared-ini-file-loader/getSsoSessionData.js"() {
    ...
    getSsoSessionData = /* @__PURE__ */ __name((data) => Object.entries(data).filter(([key]) => key.startsWith(import_types4.IniSectionType.SSO_SESSION + CONFIG_PREFIX_SEPARATOR)).reduce((acc, [key, value]) => ({ ...acc, [key.substring(key.indexOf(CONFIG_PREFIX_SEPARATOR) + 1)]: value }), {}), "getSsoSessionData");
  }
});
...
var init_NodeUseDualstackEndpointConfigOptions = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/endpointsConfig/NodeUseDualstackEndpointConfigOptions.js"() {
    ...
    NODE_USE_DUALSTACK_ENDPOINT_CONFIG_OPTIONS = {
      environmentVariableSelector: /* @__PURE__ */ __name((env) => booleanSelector(env, ENV_USE_DUALSTACK_ENDPOINT, SelectorType.ENV), "environmentVariableSelector"),
...
var init_NodeUseFipsEndpointConfigOptions = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/endpointsConfig/NodeUseFipsEndpointConfigOptions.js"() {
    ...
    NODE_USE_FIPS_ENDPOINT_CONFIG_OPTIONS = {
      environmentVariableSelector: /* @__PURE__ */ __name((env) => booleanSelector(env, ENV_USE_FIPS_ENDPOINT, SelectorType.ENV), "environmentVariableSelector"),
...
var init_invalidFunction = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/client/invalid-dependency/invalidFunction.js"() {
    init_esm();
    invalidFunction = /* @__PURE__ */ __name((message) => () => {
...
var init_ErrorSchema = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/schema/schemas/ErrorSchema.js"() {
    ...
    error = /* @__PURE__ */ __name((namespace, name, traits, memberNames, memberList, _ctor) => Schema.assign(new ErrorSchema(), {
      name,
      namespace,
      traits,
      memberNames,
...
var import_types7, Command, ClassBuilder;
...
var init_create_aggregated_client = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/client/smithy-client/create-aggregated-client.js"() {
    init_esm();
    createAggregatedClient = /* @__PURE__ */ __name((commands, Client2, options) => {
...
var import_types8, knownAlgorithms, getChecksumConfiguration, resolveChecksumRuntimeConfig;
var init_checksum = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/client/smithy-client/extensions/checksum.js"() {
    init_esm();
    import_types8 = __toESM(require_dist_cjs());
    knownAlgorithms = Object.values(import_types8.AlgorithmId);
    getChecksumConfiguration = /* @__PURE__ */ __name((runtimeConfig) => {
      const checksumAlgorithms = [];
      for (const id in import_types8.AlgorithmId) {
        const algorithmId = import_types8.AlgorithmId[id];
...
var init_object_mapping = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/client/smithy-client/object-mapping.js"() {
    init_esm();
    __name(map2, "map");
    convertMap = /* @__PURE__ */ __name((target) => {
      const output = {};
    ...
    nonNullish = /* @__PURE__ */ __name((_) => _ != null, "nonNullish");
    pass = /* @__PURE__ */ __name((_) => _, "pass");
  }
});
...
var init_ser_utils = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/client/smithy-client/ser-utils.js"() {
    init_esm();
    serializeFloat = /* @__PURE__ */ __name((value) => {
      if (value !== value) {
        return "NaN";
      }
      switch (value) {
    ...
    serializeDateTime = /* @__PURE__ */ __name((date2) => date2.toISOString().replace(".000Z", "Z"), "serializeDateTime");
  }
});
...
function makeBuilder(common, service, name, ep) {
  return /* @__PURE__ */ __name(function makeCommand(added, plugins, op2, $, smithyContext = {}) {
...
__export(client_exports, {
  AlgorithmId: () => import_types8.AlgorithmId,
  Client: () => Client,
  Command: () => Command,
...
var init_resolveCustomEndpointsConfig = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/endpointsConfig/resolveCustomEndpointsConfig.js"() {
    init_esm();
    init_client2();
    resolveCustomEndpointsConfig = /* @__PURE__ */ __name((input) => {
...
var init_getEndpointFromRegion = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/endpointsConfig/utils/getEndpointFromRegion.js"() {
    init_esm();
    getEndpointFromRegion = /* @__PURE__ */ __name(async (input) => {
...
var init_resolveEndpointsConfig = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/endpointsConfig/resolveEndpointsConfig.js"() {
    ...
    resolveEndpointsConfig = /* @__PURE__ */ __name((input) => {
...
var init_getHostnameFromVariants = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/regionInfo/getHostnameFromVariants.js"() {
    init_esm();
    getHostnameFromVariants = /* @__PURE__ */ __name((variants = [], { useFipsEndpoint, useDualstackEndpoint }) => variants.find(({ tags }) => useFipsEndpoint === tags.includes("fips") && useDualstackEndpoint === tags.includes("dualstack"))?.hostname, "getHostnameFromVariants");
  }
});
...
var init_getResolvedHostname = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/regionInfo/getResolvedHostname.js"() {
    init_esm();
    getResolvedHostname = /* @__PURE__ */ __name((resolvedRegion, { regionHostname, partitionHostname }) => regionHostname ? regionHostname : partitionHostname ? partitionHostname.replace("{region}", resolvedRegion) : void 0, "getResolvedHostname");
  }
});
...
var init_getResolvedPartition = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/regionInfo/getResolvedPartition.js"() {
    init_esm();
    getResolvedPartition = /* @__PURE__ */ __name((region, { partitionHash }) => Object.keys(partitionHash || {}).find((key) => partitionHash[key].regions.includes(region)) ?? "aws", "getResolvedPartition");
  }
});
...
var init_getResolvedSigningRegion = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/regionInfo/getResolvedSigningRegion.js"() {
    init_esm();
    getResolvedSigningRegion = /* @__PURE__ */ __name((hostname, { signingRegion, regionRegex, useFipsEndpoint }) => {
      if (signingRegion) {
...
var init_getRegionInfo = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/config/config-resolver/regionInfo/getRegionInfo.js"() {
    ...
    getRegionInfo = /* @__PURE__ */ __name((region, { useFipsEndpoint = false, useDualstackEndpoint = false, signingService, regionHash, partitionHash }) => {
...
var init_getIgnoreConfiguredEndpointUrls = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/endpoints/middleware-endpoint/adaptors/getIgnoreConfiguredEndpointUrls.js"() {
    ...
    ignoreConfiguredEndpointUrlsConfigSelectors = {
      environmentVariableSelector: /* @__PURE__ */ __name((env) => booleanSelector(env, ENV_IGNORE_CONFIGURED_ENDPOINT_URLS, SelectorType.ENV), "environmentVariableSelector"),
      configFileSelector: /* @__PURE__ */ __name((profile) => booleanSelector(profile, CONFIG_IGNORE_CONFIGURED_ENDPOINT_URLS, SelectorType.CONFIG), "configFileSelector"),
      default: false
    };
  }
});
...
var init_uriEncode = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/endpoints/util-endpoints/lib/uriEncode.js"() {
    init_esm();
    uriEncode = /* @__PURE__ */ __name((value) => encodeURIComponent(value).replace(/[!*'()]/g, (c) => `%${c.charCodeAt(0).toString(16).toUpperCase()}`), "uriEncode");
  }
});
...
var init_decideEndpoint = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/endpoints/util-endpoints/decideEndpoint.js"() {
    ...
    init_getEndpointUrl();
    RESULT = 1e8;
    decideEndpoint = /* @__PURE__ */ __name((bdd, options) => {
...
var init_resolveEndpointRequiredConfig = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/endpoints/middleware-endpoint/resolveEndpointRequiredConfig.js"() {
    init_esm();
    resolveEndpointRequiredConfig = /* @__PURE__ */ __name((input) => {
...
var init_ChecksumStream = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/serde/util-stream/checksum/ChecksumStream.js"() {
    init_esm();
    init_toBase64();
    ChecksumStream = class extends Readable {
      static {
      ...
      onSourceData = /* @__PURE__ */ __name((chunk) => {
        if (this.destroyed) {
          return;
        }
        try {
      ...
      onSourceEnd = /* @__PURE__ */ __name(async () => {
        if (this.destroyed) {
          return;
        }
        try {
      ...
      onSourceError = /* @__PURE__ */ __name((error2) => {
        this.destroy(error2);
      }, "onSourceError");
      onSourceClose = /* @__PURE__ */ __name(() => {
...
function getAwsChunkedEncodingStream2(stream, options) {
  ...
  const awsChunkedEncodingStream = new Readable3({
...
var init_fileStreamHasher = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/checksum/hash-stream-node/fileStreamHasher.js"() {
    init_esm();
    init_HashCalculator();
    fileStreamHasher = /* @__PURE__ */ __name((hashCtor, fileStream) => new Promise((resolve, reject) => {
    ...
    isReadStream = /* @__PURE__ */ __name((stream) => typeof stream.path === "string", "isReadStream");
  }
});
...
var init_Sha256Node = __esm({
  "node_modules/.pnpm/@smithy+core@3.32.0/node_modules/@smithy/core/dist-es/submodules/checksum/sha256/Sha256Node.js"() {
    ...
    __name(buildNativeClass3, "buildNativeClass");
...
export {
  ...
  Sha256Node,
  checksum_exports,
  init_checksum2 as init_checksum,
  Int64,
  HeaderMarshaller,
  EventStreamCodec,
  ...
  resolveEventStreamSerdeConfig,
  EventStreamSerde,
  event_streams_exports,
  init_event_streams
};
//# sourceMappingURL=chunk-F3IKMDDZ.mjs.map
