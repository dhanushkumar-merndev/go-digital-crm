...
const rolePresets = [
  ...
  ['finance_executive', 'Finance Executive', 400, false],
  ['insurance_executive', 'Insurance Executive', 400, false],
  ['rto_executive', 'RTO Executive', 400, false],
  ['exchange_executive', 'Used Car / Exchange Executive', 400, false],
  ['delivery_executive', 'Delivery Executive', 400, false],
  ['customer_relationship_executive', 'Customer Relationship Executive', 400, false],
...
async function main() {
  ...
  const telecallerPermissionKeys = new Set([
    ...
    // trigger, so seeding these would fail with
    // TELECALLER_APPOINTMENT_PERMISSION_NOT_ALLOWED.
    'document.upload',
    'document.download',
    'email.send',
  ]);
  const rolePermissionPrefixes = {
    ...
    finance_executive: ['finance.', 'customer.', 'booking.', 'document.'],
    insurance_executive: ['insurance.', 'customer.', 'booking.', 'document.'],
    rto_executive: ['rto.', 'customer.', 'booking.', 'document.'],
    exchange_executive: ['exchange.', 'customer.', 'booking.', 'document.'],
    delivery_executive: ['delivery.', 'customer.', 'booking.', 'document.'],
